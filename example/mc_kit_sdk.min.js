...
break;case d.RESOLVED:g=!0;break;default:throw Error("\u8bf7\u786e\u8ba4\u4f60\u7684 appKey \u6b63\u786e.");}if(g)if(a&&-1!==m.indexOf(a.toUpperCase()))"function"===typeof c&&(p=c,c=t),a=a+"_!_"+(new Date).getTime(),q(a,c),"function"===typeof p&&b.h5.watchOnce(a,function(a){p(a)});else throw Error("\u672a\u627e\u5230\u8be5 ["+a+"] API, \u8bf7\u786e\u8ba4\u4f60\u8c03\u7528\u7684 API .");};b.h5.watch=function(a,c,b){var d;if("string"===typeof a&&"function"===typeof c)return b=b||{},d=(d=b.flag)||(new Date).getTime()+
